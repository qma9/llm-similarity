...
class Review(Base):
    ...
    centralized = Column(Float, index=True, nullable=True)
    secretive = Column(Float, index=True, nullable=True)
    hierarchical = Column(Float, index=True, nullable=True)
    formal = Column(Float, index=True, nullable=True)
    stagnating = Column(Float, index=True, nullable=True)
    risk_averse = Column(Float, index=True, nullable=True)
